...
import com.printlok.pdp.auth.dto.LoginRequest;
import com.printlok.pdp.auth.models.JwtBlacklist;
import com.printlok.pdp.auth.models.LoginAttempt;
import com.printlok.pdp.auth.models.RefreshToken;
import com.printlok.pdp.auth.repositories.JwtBlacklistRepository;
import com.printlok.pdp.auth.repositories.LoginAttemptRepository;
import com.printlok.pdp.auth.repositories.RefreshTokenRepository;
import com.printlok.pdp.common.dto.ResponseStructure;
import com.printlok.pdp.exceptions.TokenCompromiseException;
...
public class AuthService {
	...
	public ResponseEntity<ResponseStructure<Map<String, Object>>> authenticateUser(LoginRequest loginRequest,
		...
		ResponseCookie accessCookie = createCookie("jwt", accessToken, jwtUtils.getAccessTokenTtl(), "/", "Strict");
	...
	public ResponseEntity<ResponseStructure<String>> logout(HttpServletRequest request) {
		...
		ResponseCookie clearAccess = createCookie("jwt", "", Duration.ZERO, "/", "Strict");
		ResponseCookie clearRefresh = createCookie("refresh", "", Duration.ZERO, "/api/auth/refresh", "Strict");
